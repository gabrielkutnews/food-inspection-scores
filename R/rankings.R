...
function postHeight(){
  ...
  // Measure the BODY, not documentElement. Inside an iframe, documentElement.scrollHeight is
  // clamped to the frame viewport, so it reports whatever height the parent already set: a
  // frame opened at 1440px for 637px of content reports 1440 and never shrinks. body height
  // is content-driven, so it can go down as well as up. Verified: with the frame forced to
  // 1440, documentElement.scrollHeight said 1440 while the body measured 637.
